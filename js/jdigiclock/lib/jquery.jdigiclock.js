...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            return this.each(function() {
                ...
                html    += '<p id="left_arrow"><img src="/js/jdigiclock/images/icon_left.png" /></p>';
                html    += '<p id="right_arrow"><img src="/js/jdigiclock/images/icon_right.png" /></p>';
    ...
    $.fn.getWeather = function(el) {
        ...
        $.getJSON('/js/jdigiclock/lib/proxy/' + proxy + '?location=' + el.weatherLocationCode + '&metric=' + el.weatherMetric, function(data) {
            ...
            el.find('#forecast_container').append('<div id="update"><img src="/js/jdigiclock/images/refresh_01.png" alt="reload" title="reload" id="reload" />' + el.timeUpdate + '</div>');
