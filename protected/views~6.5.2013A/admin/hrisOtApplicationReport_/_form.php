...
<?php $form = $this->beginWidget('GxActiveForm', array(
	'id' => 'hris-ot-application-report-form',
...
?>
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->dropDownList($model, 'next_lvl_id', GxHtml::listDataEx(HrisAccessLvl::model()->findAllAttributes(null, true))); ?>
		...
		<?php echo $form->textField($model, 'sub_code_id', array('maxlength' => 10)); ?>
