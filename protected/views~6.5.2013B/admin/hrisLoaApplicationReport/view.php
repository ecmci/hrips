...
<h2> echo GxHtml::encode($model->getRelationLabel('hrisLoaAttachments')); ?></h2>
<h2>Attachments</h2>
	echo GxHtml::openTag('ul');
	foreach($model->hrisLoaAttachments as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('hrisLoaAttachments/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
