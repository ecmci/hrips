...
$this->menu=array(
	array('label'=>Yii::t('app', 'Edit Application') . ' ' . $model->label(), 'url'=>array('update', 'id' => $model->id)),
	array('label'=>Yii::t('app', 'Cancel Application') . ' ' . $model->label(), 'url'=>'#', 'linkOptions' => array('submit' => array('cancel', 'id' => $model->id), 'confirm'=>'Are you sure you want to cancel this application?')),
...
array(
  ...
  'value'=>WebApp::formatDate($model->clockedin_datetime),
),
array(
  'name'=>'clockedout_datetime',
  'value'=>WebApp::formatDate($model->clockedout_datetime),
),
