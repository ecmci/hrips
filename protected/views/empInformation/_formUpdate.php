...
<fieldset class="myclass"> <!--Personal info ;-->
	...
	<table id="personalinfo" border="1">
		...
		<tr>
			...
			<td><?php echo $form->textField($model,'BdayPlace',array('size'=>60,'maxlength'=>100)); ?>
		...
		<tr>
			...
			<td><?php echo $form->textField($model,'AgencyEmpNo'); ?>
				<?php echo $form->error($model,'AgencyEmpNo'); ?></td>
        <td><?php //echo $form->labelEx($model,'Position'); ?></td>
        <td colspan="2"><?php //echo $form->textField($model,'Position'); ?><?php echo $form->error($model,'Position'); ?></td>
		</tr>
		...
		<table id="queries" border="1">
			...
			<tr>
				<td width="65%"><b>Are you related by consanguinity or affinity to any of the following :</b><br><br>
					<b>a.</b> 	Within the third degree (for National Government Employees): <br>
				...
				<td>
					...
					<div class="row">
						<?php
							echo $form->radioButtonList($modQueries,'ThirdDegreeRelated',
							array('1'=>'Yes','0'=>'No'),
							array(
			...
			<tr>
				<td width="65%"><b>b. </b>Within the fourth degree (for Local Government Employees):<br>
					appointing authority or recommending authority where you will be appointed?</td>
				<td>
					<!-- choices -->
					<div class="row">
						<?php
							echo $form->radioButtonList($modQueries,'FourthDegreeRelated',
							array('1'=>'Yes','0'=>'No'),
							array(
								  'template'=>'{input}{label}',
								  'separator'=>'',
			...
			<tr>
				...
				<td>
					...
					<div class="row">
						<?php
							echo $form->radioButtonList($modQueries,'FormallyCharged',
							array('1'=>'Yes','0'=>'No'),
							array(
								  'template'=>'{input}{label}',
								  'separator'=>'',
			...
			<tr>
				...
				<td>
					...
					<div class="row">
						<?php
							echo $form->radioButtonList($modQueries,'AdminOffense',
							array('1'=>'Yes','0'=>'No'),
							array(
								  'template'=>'{input}{label}',
								  'separator'=>'',
			...
			<tr>
				...
				<td>
					...
					<div class="row">
						<?php
							echo $form->radioButtonList($modQueries,'CrimeConvicted',
							array('1'=>'Yes','0'=>'No'),
							array(
								  'template'=>'{input}{label}',
								  'separator'=>'',
			...
			<tr>
				...
				<td>
					...
					<div class="row">
						<?php
							echo $form->radioButtonList($modQueries,'SeparatedService',
							array('1'=>'Yes','0'=>'No'),
							array(
								  'template'=>'{input}{label}',
								  'separator'=>'',
			...
			<tr>
				...
				<td>
					...
					<div class="row">
						<?php
							echo $form->radioButtonList($modQueries,'ElectionCandidate',
							array('1'=>'Yes','0'=>'No'),
							array(
								  'template'=>'{input}{label}',
								  'separator'=>'',
			...
			<tr>
				...
				<td>
					...
					<div class="row">
						<?php
							echo $form->radioButtonList($modQueries,'Indigenous',
							array('1'=>'Yes','0'=>'No'),
							array(
								  'template'=>'{input}{label}',
								  'separator'=>'',
			...
			<tr>
				...
				<td>
					...
					<div class="row">
						<?php
							echo $form->radioButtonList($modQueries,'DiffAbled',
							array('1'=>'Yes','0'=>'No'),
							array(
								  'template'=>'{input}{label}',
								  'separator'=>'',
			...
			<tr>
				...
				<td>
					...
					<div class="row">
						<?php
							echo $form->radioButtonList($modQueries,'SoloParent',
							array('1'=>'Yes','0'=>'No'),
							array(
								  'template'=>'{input}{label}',
								  'separator'=>'',
