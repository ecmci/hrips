...
<table class="container">
    ...
    <tbody>
        ...
        <tr>
            <td colspan="2">Salary Adjustments</td><td></td><td class="right"><?php echo $model->Adjustment+$model->Salary_Adjustment;
			?></td>
        </tr>
        ...
        <tr>
            <td colspan="2" class="">PHIC Contribution</td><td></td><td class="right"><?php echo $model->PHIC."<br>";
			//echo $model->PHIC + $model->SSS;?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" class="">Health Premium</td><td></td><td class="right"><?php echo $model->Insurance;?></td>
        </tr>
		<?php //endif ?>
        <tr>
        ...
        <tr>
            <td colspan="2" class=""><!--VL Credits--></td><td><?php //echo $model->vl_credits; ?></td><td class=""></td>
        </tr>   
    </tbody>
