<?php
Yii::app()->clientScript->registerScript('print-ot-report',"
...
<tr>
    ...
    <td><?php echo GxHtml::valueEx($data->subCode);?></td>
    <td><?php echo $data->getCurrentStatus();?></td>
    <td><?php echo $data->in_datetime;?></td>
    <td><?php echo $data->out_datetime;?></td>
    <td><?php echo $data->approved_hours;?></td>
