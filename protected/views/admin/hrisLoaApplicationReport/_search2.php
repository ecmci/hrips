...
<div class="row fluid">
   ...
   <div class="span3">
	...
	<div class="span3">
		...
		<?php $this->widget('ext.CJuiDateTimePicker.CJuiDateTimePicker',array(
			 'model'=>$model,		    
		    'name'=>'HrisLoaApplicationReport[from]',
		    'value'=>$model->from,		    	    		    
		    'options'=>array(
				  'showAnim'=>'fade',
          'dateFormat'=>'yy-mm-dd',          
	...
	<div class="span3">
		...
		<?php $this->widget('ext.CJuiDateTimePicker.CJuiDateTimePicker',array(
			 'model'=>$model,		    
		    'name'=>'HrisLoaApplicationReport[to]',
		    'value'=>$model->to,		    	    		    
		    'options'=>array(
				  'showAnim'=>'fade',
          'dateFormat'=>'yy-mm-dd',          
  ...
  <div class="span3">
		...
		<?php echo $form->dropDownList($model, 'job_code_id', GxHtml::listDataEx(JobCode::model()->findAll(array('condition'=> "title LIKE '%LOA%'",'order'=>'title asc'))), array('prompt' => Yii::t('app', ''))); ?>
	</div>
