...
class HrisOtApplicationReport extends BaseHrisOtApplicationReport
{
	...
	public function rules() {
		return array(
			...
			array('approved_hours, hours, minutes, sup_approve_datetime, sup_disapprove_reason, mgr_approve_datetime, mgr_disapprove_reason, hr_approve_datetime, hr_disapprove_reason, employer_approve_datetime, employer_disapprove_reason', 'safe'),
