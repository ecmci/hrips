...
class HrisLoaApplication extends BaseHrisLoaApplication
{
	...
	public function rules() {
		return array(
			...
			array('hours_requested, from_datetime, to_datetime, remarks, reliever_approve_datetime, sup_approve_datetime, sup_disapprove_reason, hr_approve_datetime, hr_disapprove_reason', 'safe'),
