 ...
 * property or method in class "HrisOtApplication".
 *
 ...
 */
abstract class BaseHrisOtApplication extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'HrisOtApplication|HrisOtApplications', $n);
	}
	...
	public function rules() {
		return array(
			...
			array('sup_approve_datetime, sup_disapprove_reason, mgr_approve_datetime, mgr_disapprove_reason, hr_approve_datetime, hr_disapprove_reason, employer_approve_datetime, employer_disapprove_reason, sub_code_id', 'safe'),
