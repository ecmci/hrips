...
<table class="container">
    <thead>
        ...
        <tr>
            <th class="left">Position</th><th class="normal-weight underline">Updating...<?php //echo $model->Position;?></th><th class="right">Pay Date</th><th class="normal-weight underline"><?php echo date('M. d, Y',strtotime($model->Payroll_Date));?></th>
        </tr>    
    </thead>
    <tbody>
         <tr>
