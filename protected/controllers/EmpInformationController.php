...
class EmpInformationController extends Controller
{
   ...
   private function getMyeducation(){
		$education=array();
		//
   ...
   private function getMychildren(){
	...
	private function getMycivilservice(){
		$civilServices=array();
	...
	private function isValidCivilservice($civilServices){
	...
	private function getMyworkexps(){
		$workExps=array();
	...
	private function isValidWork($workExps){
	...
	private function getMyCivicorgs(){
		$civicorgs=array();
	...
	private function isValidOrg($civicorgs){
	...
	private function getMyTrainings(){
		$trainings=array();
		$modTrain=new EmpTraining;
	...
	private function isValidTraining($trainings){
	...
	private function isValidRef($refs){
		$limit = sizeof($refs);
		$modRef = new EmpRef;
		for($i=0 ; $i < $limit ; $i++){			
			$modRef->EmpID = $_POST['EmpInformation']['EmpID'];
