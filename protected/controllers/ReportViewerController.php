...
class ReportViewerController extends Controller
{
	...
	public function actionIndex2() 
	{
		...
		$chkbox_count = 0;
		if (isset($_POST['chkEmpID'])) $chkbox_count++;
		if (isset($_POST['chkFname'])) $chkbox_count++;
		if (isset($_POST['chkHome'])) $chkbox_count++;
		if (isset($_POST['chkContact'])) $chkbox_count++;
		if (isset($_POST['chkBday'])) $chkbox_count++;
		if (isset($_POST['chkGender'])) $chkbox_count++;
		if (isset($_POST['chkCivilStat'])) $chkbox_count++;
		if (isset($_POST['chkHire'])) $chkbox_count++;
		if (isset($_POST['chkSSS'])) $chkbox_count++;
		if (isset($_POST['chkTIN'])) $chkbox_count++;
		if (isset($_POST['chkPHIC'])) $chkbox_count++;
		if (isset($_POST['chkHDMF'])) $chkbox_count++;
		if (isset($_POST['chkAcctNo'])) $chkbox_count++;
		if (isset($_POST['chkDept'])) $chkbox_count++;
		if (isset($_POST['chkPosition'])) $chkbox_count++;
		if (isset($_POST['chkEmailadd'])) $chkbox_count++;
		if (isset($_POST['chkContact'])) $chkbox_count++;
		if (isset($_POST['chkMB'])) $chkbox_count++;
