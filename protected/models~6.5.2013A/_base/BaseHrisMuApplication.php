 ...
 * property or method in class "HrisMuApplication".
 *
 ...
 */
abstract class BaseHrisMuApplication extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'HrisMuApplication|HrisMuApplications', $n);
	}
	...
	public function rules() {
		return array(
			array('emp_id, dept_id, clockedin_datetime, clockedout_datetime, hours, reason, timestamp', 'required'),
			array('emp_id, dept_id, job_code_id, next_lvl_id, reliever_id, reliever_approve, sup_id, sup_approve, hr_id, hr_approve', 'numerical', 'integerOnly'=>true),
			array('hours', 'length', 'max'=>3),
			array('from_datetime, to_datetime, remarks, reliever_approve_datetime, sup_approve_datetime, sup_disapprove_reason, hr_approve_datetime, hr_disapprove_reason', 'safe'),
			array('job_code_id, next_lvl_id, from_datetime, to_datetime, remarks, reliever_id, reliever_approve, reliever_approve_datetime, sup_id, sup_approve, sup_approve_datetime, sup_disapprove_reason, hr_id, hr_approve, hr_approve_datetime, hr_disapprove_reason', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, emp_id, dept_id, job_code_id, next_lvl_id, clockedin_datetime, clockedout_datetime, hours, from_datetime, to_datetime, reason, remarks, reliever_id, reliever_approve, reliever_approve_datetime, sup_id, sup_approve, sup_approve_datetime, sup_disapprove_reason, hr_id, hr_approve, hr_approve_datetime, hr_disapprove_reason, timestamp', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			...
			'dept_id' => null,
			'job_code_id' => null,
			'next_lvl_id' => Yii::t('app', 'Next Lvl'),
